...
parser.add_argument("--max_iterations", type=int, default=900000, help="maximum epoch number to train")
parser.add_argument("--max_epochs", type=int, default=580, help="maximum epoch number to train")
...
parser.add_argument(
    "--module", default="networks.DFAFormer.DFAFormer",help="The module that you want to load as the network, e.g. networks.DAEFormer.DAEFormer"
