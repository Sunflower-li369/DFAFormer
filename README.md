...
Task | Dataset
------------ | -------------|----
Medical segmentation | [Synapse](https://drive.google.com/uc?export=download&id=18I9JHH_i0uuEDg-N6d7bfMdf7Ut6bhBi) |
...
3) Run the below code to train the DAEFormer on the synapse dataset.
 ...
 4) Run the code to test the DAEFormer on the synapse dataset.
    ```bash
...
## Results
Performance comparision on Synapse dataset.

![results](https://github.com/mindflow-institue/DAEFormer/assets/61879630/da13cceb-fbef-40a2-9605-be07ca1cac2f)

### Query
All implementation done by Sunflower. For any query please contact us for more information.
